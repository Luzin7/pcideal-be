...
type PartService struct {
	...
	PartMatchingService repository.PartMatchingRepository
}

func NewPartService(partRepository repository.PartRepository, scrapperClient repository.ScraperClientRepository, googleAIRepository repository.GoogleAIRepository, partMatchingService repository.PartMatchingRepository) *PartService {
	return &PartService{
		PartRepository:      partRepository,
		ScraperClient:       scrapperClient,
		GoogleAIClient:      googleAIRepository,
		PartMatchingService: partMatchingService,
	}
}

func (ps *PartService) needToUpdate(part *entity.Part) bool {
...
func (partService *PartService) CreatePart(part *entity.Part) *errors.ErrService {
...
func (partService *PartService) GetAllParts() ([]*entity.Part, *errors.ErrService) {
...
func (partService *PartService) GetPartByID(id string) (*entity.Part, *errors.ErrService) {
...
func (partService *PartService) GetPartByModel(model string) (*entity.Part, *errors.ErrService) {
...
func (partService *PartService) GenerateBuildRecomendations(usageType string, cpuPreference string, gpuPreference string, budget int64) (*presenters.RecommendedBuildsPresenter, *errors.ErrService) {
	...
	for i := range aiBuildResponse.Builds {
		...
		var gpuFoundByBestMatch *entity.Part
		...
		if strings.ToLower(gpu) != "integrado" {
			...
			gpuFoundByBestMatch = &entity.Part{
				Brand: gpuBrand,
				Model: "Integrada",
				URL:   cpuFoundByBestMatch.URL,
			}
